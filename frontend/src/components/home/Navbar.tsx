    ...
    <Navbar bg='' className="ps-0 pe-2 pb-0 border-bottom">
      <Container fluid className='px-0'>
        <div className='d-flex justify-content-end w-100'>
          {/* <span className='d-flex align-items-center ps-4 font-small fw-bold'>
            Фраза дня: Берегите Природу!
          </span> */}
          <Nav className='align-items-center pe-4'>
            <Dropdown as={Nav.Item}>
              <DropdownToggle as={Nav.Link} className='text-dark me-lg-3 text-white'>
                <span className='align-items-center text-black'>
                  <BsFillBellFill className='icon'/>
                  {/* //TODO: Add a red circle on a bell and a dropdown itself */}
                </span>
              </DropdownToggle>
            </Dropdown>
