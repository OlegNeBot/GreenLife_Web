...
namespace GreenLifeLib.Migrations
{
    ...
    [Migration("20220624095629_DateTimesChangedToString")]
    partial class DateTimesChangedToString
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GreenLifeLib.AccountAction", b =>
                {
                    ...
                    b.ToTable("account_action", (string)null);
                });
            ...
            modelBuilder.Entity("GreenLifeLib.Token", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("GreenLifeLib.Token", b =>
                {
                    b.HasOne("GreenLifeLib.Account", "Account")
                        .WithOne("Token")
                        .HasForeignKey("GreenLifeLib.Token", "AccountId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
